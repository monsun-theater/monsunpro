...
performance_dates:
  ...
  -
    ...
    cancelled: false
    last_performance: false
    ticket_url: 'https://www.performingarts-festival.de/de'
    additional_info_performance_toggle: true
    additional_info_performance: 'Im Rahmen des Performing Arts Festivals Berlin - Eintritt frei!'
    monsun_digital_section: null
    monsun_digital: true
    streaming-link: 'https://youtu.be/HQTSqF3MJkc'
    streaming_info: true
    additional_streaming_info: 'In diesem Stream wird die Aufzeichnungen der FILETSTÜCKE aus Hamburg gezeigt. Simultan dazu streamt die Vagantenbühne die Berliner Inszenierung.'
  -
    ...
    monsun_digital_section: null
    monsun_digital: true
    streaming-link: 'https://youtu.be/NEnhBogHOKQ'
    streaming_info: true
    additional_streaming_info: 'In diesem Stream wird die Aufzeichnungen der FILETSTÜCKE aus Hamburg gezeigt. Simultan dazu streamt die Vagantenbühne die Berliner Inszenierung.'
